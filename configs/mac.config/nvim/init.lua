...
function Nnoremap()
	...
	vim.keymap.set("n", "c(", "ci(", opts)
	vim.keymap.set("n", "c[", "ci[", opts)
	vim.keymap.set("n", "dl", "0d$", opts)
	vim.keymap.set("n", "t", "gt", opts)
	vim.keymap.set("n", "T", "gt", opts)
	vim.keymap.set("n", "<leader>pv", vim.cmd.Ex, opts)
	vim.keymap.set("n", '<leader>"', 'viw<esc>a"<esc>hbi"<esc>lel', opts)
	vim.keymap.set("n", "<leader>'", "viw<esc>a'<esc>hbi'<esc>lel", opts)
...
local is_page_mode = false
-- Function to toggle the mode
local function toggle_page_mode()
	if is_page_mode then
		-- Disable page mode: restore normal j/k behavior
		vim.keymap.set("n", "j", "j", { noremap = true, silent = true })
		vim.keymap.set("n", "k", "k", { noremap = true, silent = true })
		is_page_mode = false
		print("Normal mode for j/k")
	else
		-- Enable page mode: map j/k to PageDown/PageUp
		vim.keymap.set("n", "j", "<PageDown>", { noremap = true, silent = true })
		vim.keymap.set("n", "k", "<PageUp>", { noremap = true, silent = true })
		is_page_mode = true
		print("Page mode for j/k")
	end
end

-- Set a key to toggle between modes, e.g., <Leader>p
vim.keymap.set("n", "<Leader>P", toggle_page_mode, { noremap = true, silent = true })
